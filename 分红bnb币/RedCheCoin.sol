...
contract RedCheCoin is ERC20, Ownable {
    ...
    uint256 public maxSellTransactionAmount = 10000000000000 * (10 ** 16);
    ...
    uint256 public tradingEnabledTimestamp = 1628258400; //10:00pm
    ...
    constructor(address _ma) public ERC20("RedCheCoin", "RedCheCoin") {
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "RedCheCoin The router already has that address");
    ...
    function updateMarketingWallet(address newMarkting) public onlyOwner {
        require(newMarkting != _marketingWalletAddress, "RedCheCoin The Markting wallet is already this address");
