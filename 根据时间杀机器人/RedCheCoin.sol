...
contract RedCheCoin is ERC20, Ownable {
    ...
    DividendTracker public dividendTracker;          //分红跟踪
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        newDividendTracker.excludeFromDividends(address(uniswapV2Router));          //0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3地址
    ...
    function _transfer(
        ...
        if (
            ...
            !isMng &&                           //非营销钱包或者流动池钱包之类的
            tradingIsEnabled &&                         
            block.timestamp <= tradingEnabledTimestamp + 9 seconds) {  //当前块的时间戳小于等于 可交易时间戳+9秒。应该是在9秒内抢到
            addBot(to);                                 //添加黑名单
        }
